...
namespace FlaUiTests
{
    ...
    public class UnitTest1
    {
        ...
        {
            //var application = FlaUI.Core.Application.Launch(@"C:\Program Files (x86)\Microsoft Office\root\Office16\WINWORD.exe");
            //var application = FlaUI.Core.Application.Launch(@"notepad.exe");
            var application = FlaUI.Core.Application.Launch(@"wordpad.exe");
            ...
            Keyboard.Type("Hello My Name Is");
            Keyboard.Type(VirtualKeyShort.SPACE);

            Keyboard.TypeSimultaneously(VirtualKeyShort.LCONTROL,VirtualKeyShort.KEY_B);
        ...
        public void TestCalc()
        {
            ...
            var application = FlaUI.Core.Application.LaunchStoreApp("Microsoft.WindowsCalculator_8wekyb3d8bbwe!App");
            var automation = new UIA3Automation();
            var mainWindow = application.GetMainWindow(automation);
            ConditionFactory cf = new ConditionFactory(new UIA3PropertyLibrary());
            ...
            mainWindow.FindFirstDescendant(cf.ByAutomationId("CalculatorResults")).DrawHighlight();

            var x = mainWindow.FindFirstDescendant(cf.ByAutomationId("CalculatorResults"));

            Assert.IsTrue(x.Name.Contains("2"));
